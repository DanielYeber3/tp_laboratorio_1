...
void* ll_get(LinkedList* this, int index)
{
    ...
    if(this != NULL)
    {
        nodeOf = getNode(this,index);

        if(nodeOf != NULL)
        {
           returnAux = nodeOf->pElement;
        }
    ...
    if(this != NULL && this2 != NULL)
    {
        ...
        for(i = 0; i < len2; i++)
        {
            ...
            if(auxPElement != NULL)
            {
                ...
                auxContains = ll_contains(this, auxPElement);
                   ...
                   for(i = 0; i < len - 1; i++)
                    {
                        ...
                        for( j = i + 1; j < len; j++)
                        {
                            ...
                            pSecondNode = ll_get(this,j);

                            if(pFunc(pFirstNode, pSecondNode) > 0)
                            {
